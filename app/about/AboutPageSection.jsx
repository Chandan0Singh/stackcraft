            ...
            <section className="about">
                <div className="about-content">
                    <div className="about-content-top">
                        <div className="about-content-textbox">
                            ...
                            <p
                                ...
                                ref={descriptionRef}
                            >
                                StackCraft Studio is a digital product studio
                                focused on building modern websites, web
                                applications, e-commerce platforms, and
                    ...
                    <div className="about-whyus">
                        <p className="description about-whyus-description grey">
                            Why us
                        </p>
                        ...
                        <p
                            ...
                            ref={titleRef2}
                        >
                            At StackCraft Studio, we combine design,
                            development, and modern technology to build digital
                            products that solve real business problems. We work
                            closely with our clients from idea to launch,
                            focusing on performance, scalability, and long-term
                            growth.
                        </p>
                    </div>
                            ...
                            <div className="about-sticky-item-left">
                                <div className="about-sticky-item-left-textbox">
                                    ...
                                    <p className="description about-sticky-item-left-textbox-description grey">
                                        We build fast, responsive, and scalable
                        ...
                        >
                            <div className="about-sticky-item-left">
                                <div className="about-sticky-item-left-textbox">
                                    ...
                                    <p className="description about-sticky-item-left-textbox-description grey">
                                        We create conversion-focused
                                        e-commerce experiences with modern
                                        storefronts, secure integrations, and
                        ...
                        >
                            <div className="about-sticky-item-left">
                                <div className="about-sticky-item-left-textbox">
                                    ...
                                    <p className="description about-sticky-item-left-textbox-description grey">
                                        We integrate AI and generative AI
                                        capabilities into digital products to
                                        automate workflows, improve user
                                        experiences, and unlock new
                                        possibilities.
                                    </p>
                                </div>
                        ...
                        >
                            <div className="about-sticky-item-left">
                                <div className="about-sticky-item-left-textbox">
                                    ...
                                    <p className="description about-sticky-item-left-textbox-description grey">
                                        We keep your digital products secure,
                                        updated, optimized, and ready to grow
                                        with your business.
                                    </p>
                                </div>
