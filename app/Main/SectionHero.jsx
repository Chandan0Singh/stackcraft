          ...
          <div className="hero-content-left">
            <div className="hero-textbox">
              <div className="hero-titlebox">
                ...
                <h1 className="headline hero-headline white" ref={titleRef} >We Build <br /> Digital Experiences</h1>
              </div>
              <p className="big-description grey opacity-blur" ref={descriptionRef} >We design and build modern websites, web applications, and AI-powered digital solutions that help businesses grow.</p>
            </div>
