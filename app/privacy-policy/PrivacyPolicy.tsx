...
return ( <ReactLenis root> <main ref={pageRef} className="legal-page"> <LegalPage title="Privacy Policy"> <div ref={sectionsRef} className="legal-content"> <div className="legal-section"> <h2>1. Introduction</h2> <p>
...
when you use our website and services. </p> </div>
