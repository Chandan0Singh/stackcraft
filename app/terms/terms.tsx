...
return ( <ReactLenis root> <main ref={pageRef} className="legal-page"> <LegalPage title="Terms of Service"> <div ref={sectionsRef} className="legal-content"> <div className="legal-section"> <h2>1. Acceptance of Terms</h2> <p>
...
services. </p> </div>
        ...
        <div className="legal-section">
          ...
          <p>
            ...
            development, AI solutions, maintenance and support, consulting,
            and related technology services. The exact scope of each project
            will be agreed upon with the client before work begins.
          </p>
        </div>
        ...
        <div className="legal-section">
          ...
          <p>
            ...
            by us remain our intellectual property until the agreed payments
            and project obligations have been completed.
          </p>
        </div>
        ...
        <div className="legal-section">
          ...
          <p>
            ...
            services, or other external services. We are not responsible for
            changes, interruptions, or failures caused by such third-party
            providers.
          </p>
        </div>
